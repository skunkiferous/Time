...
/**
 * This class is a copy of java.util.TimerTask form the project Apache Harmony.
 *
...
public abstract class TimerTask implements Runnable {
     ...
     */
    void setScheduledTime(final long time) {
        synchronized (lock) {
            scheduledTime = time;
        }
    }
    ...
    public boolean cancel() {
        synchronized (lock) {
            final boolean willRun = !cancelled && when > 0;
            cancelled = true;
            return willRun;
        }
    }
